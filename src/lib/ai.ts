...
export function localGenerateDraft(rawTitle: string, rawKeyphrase = ""): BlogPost {
  ...
  const sections = [
    ...
    },
    {
      ...
      list: [
        ...
        "خصم موسمي يصل إلى 25% على جميع الرحلات حالياً.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `تشمل معظم الباقات وسائل السلامة المعتمدة ومياه الشرب والثلج، مع إضافات اختيارية مثل الصيد والتصوير الاحترافي والكاياك والوجبات. ويمكنك الاطلاع على التفاصيل الكاملة وحجز باقتك مباشرةً من صفحة الحجوزات، مع خصم موسمي يصل إلى 25% حالياً.`,
      ],
    },
    {
  ...
  const faq = [
    ...
    { q: `كم تبلغ أسعار ${kp}؟`, a: "تختلف الأسعار حسب نوع الرحلة ومدتها وعدد الأشخاص، وتبدأ من باقات اقتصادية بالساعة، مع خصم موسمي يصل إلى 25% على جميع الرحلات حالياً." },
