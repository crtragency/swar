...
export const PACKAGES: Pkg[] = [
  {
    ...
    rows: [
      { label: "السعر الأساسي — 4 ساعات + مشروبات · لـ 6 أشخاص + أدوات سلامة", oldPrice: 945, price: 945, durationHours: 4 },
    ],
    addons: [
  ...
  },
  {
    ...
    yacht: YACHT_FEATURES,
    rows: [
      { label: "🕕 6 ساعات — حتى 6 أشخاص", oldPrice: 1103, price: 1103, durationHours: 6 },
      { label: "🕗 8 ساعات — حتى 6 أشخاص", oldPrice: 1260, price: 1260, durationHours: 8 },
      { label: "🕙 10 ساعات — حتى 6 أشخاص", oldPrice: 1496, price: 1496, durationHours: 10 },
      { label: "🌅 12 ساعة — حتى 6 أشخاص", oldPrice: 1733, price: 1733, durationHours: 12 },
    ],
    addons: [
  ...
  },
  {
    ...
    yacht: YACHT_FEATURES,
    rows: [
      { label: "🕧 نصف ساعة — حتى 6 أشخاص", oldPrice: 199, price: 199, durationHours: 0.5 },
      { label: "🕐 ساعة كاملة — حتى 6 أشخاص", oldPrice: 299, price: 299, durationHours: 1 },
      { label: "🕑 ساعتان — حتى 6 أشخاص", oldPrice: 599, price: 599, durationHours: 2 },
    ],
  ...
  },
  {
    ...
    rows: [
      { label: "🌅 الرحلة الصباحية — 9:00 ص حتى 12:00 م", oldPrice: 897, price: 897, note: "حتى 6 أشخاص", durationHours: 3 },
    ],
    includes: [
      "🐬 مشاهدة الدلافين",
      "🕐 4 ساعات كاملة",
  ...
  },
  {
    ...
    note: "استمتع بتجربة بحرية فاخرة تجمع بين الصيد الاحترافي وتجربة الطهي المباشر في قلب بحر ثول. نأخذك إلى أفضل مواقع الصيد، ثم نحوّل صيدك إلى وجبة بحرية طازجة تُحضَّر أمامك. الشخص الإضافي (فوق 6): +105 ريال.",
  },
];
