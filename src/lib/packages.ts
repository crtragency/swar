...
export const PACKAGES: Pkg[] = [
  {
    ...
    addons: [
      ...
      { id: "weekend", label: "🌙 نهاية الأسبوع", price: 210 },
    ],
  },
  {
    id: "fish",
    ...
    addons: [
      ...
      { id: "cooler", label: "📦 حافظة للسمك", price: 53 },
      { id: "hospitality", label: "☕ ضيافة شاهي وقهوة", price: 53 },
    ],
    includes: ["❄️ مياه شرب وثلج"],
    note: "نوفر مياه الشرب والثلج فقط ضمن جميع الباقات. عدة الصيد والطُعم وحافظة السمك والضيافة إضافات اختيارية — أحضر عدتك الخاصة مجاناً، أو استأجرها منا بمقابل +263 ريال.",
  },
  {
    id: "hour",
    emoji: "🕐",
  ...
  },
  {
    ...
    rows: [
      { label: "🌅 الرحلة الصباحية — 6:00 ص حتى 10:00 ص", oldPrice: 945, price: 709, note: "حتى 5 أشخاص" },
      { label: "🌇 رحلة وقت الغروب — 2:00 م حتى 6:00 م", oldPrice: 945, price: 709, note: "حتى 5 أشخاص" },
    ],
    includes: [
      "🐬 مشاهدة الدلافين",
      "🕐 4 ساعات كاملة",
