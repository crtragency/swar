...
export const PACKAGES: Pkg[] = [
  {
    ...
    includes: ["🥤 مشروبات غازية وعصيرات مشكلة", "🥨 سناكات مملحة"],
  },
  {
    id: "fish",
    emoji: "🎣",
    ...
    includes: ["❄️ مياه شرب وثلج", "🥤 مشروبات غازية وعصيرات مشكلة", "🥨 سناكات مملحة"],
    note: "نوفر مياه الشرب والثلج والمشروبات الغازية والعصيرات المشكلة والسناكات المملحة ضمن جميع الباقات. عدة الصيد والطُعم إضافة اختيارية — أحضر عدتك الخاصة مجاناً، أو استأجرها منا بمقابل +329 ريال.",
  },
  {
    id: "hour",
    emoji: "🕐",
    ...
    includes: ["🌊 جولة البحر المفتوح", "❄️ مياه شرب وثلج", "🥤 مشروبات غازية وعصيرات مشكلة", "🥨 سناكات مملحة", "🛟 أدوات السلامة كاملة"],
  },
  {
    id: "party",
    emoji: "🎉",
    ...
    includes: ["🚤 قارب مجهز VIP", "🎵 مسجل وسماعات DJ", "🛋️ جلسات مريحة", "🥤 مشروبات غازية وعصيرات مشكلة", "🥨 سناكات مملحة", "🔒 خصوصية تامة"],
  },
  {
    id: "dolphin",
    emoji: "🐬",
